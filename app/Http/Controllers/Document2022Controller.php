...
class Document2022Controller extends Controller
{
    ...
    {
        $title = 'Dokumen 2022';
        $documents = Document2022::with('conceptor')->get();
        ...
        return view('dokumen.dokumen2022.index', compact('title', 'documents'));
    }
    ...
    public function create()
    {
        ...
        return view('dokumen.dokumen2022.create', compact('title', 'conceptors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('document2022.index')->with('success', 'Dokumen berhasil ditambahkan');
    }

    public function edit($id)
    {
        $title = 'Edit Dokumen 2022';
        $document = Document2022::with('conceptor')->findOrFail($id);
        $progress = json_decode($document->progress);
        $conceptors = Conceptor::get();
        return view('dokumen.dokumen2022.edit', compact('title', 'document', 'progress', 'conceptors'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('document2022.index')->with('success', 'Dokumen berhasil diedit');
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('document2022.index')->with('success', "Dokumen berhasil diimport");
    }
}
