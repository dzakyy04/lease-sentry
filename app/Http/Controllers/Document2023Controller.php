...
class Document2023Controller extends Controller
{
    ...
    {
        $title = 'Dokumen 2023';
        $documents = Document2023::with('conceptor')->get();
        ...
        return view('dokumen.dokumen2023.index', compact('title', 'documents'));
    }
    ...
    public function create()
    {
        ...
        return view('dokumen.dokumen2023.create', compact('title', 'conceptors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('document2023.index')->with('success', 'Dokumen berhasil ditambahkan');
    }

    public function edit($id)
    {
        $title = 'Edit Dokumen 2023';
        $document = Document2023::with('conceptor')->findOrFail($id);
        $progress = json_decode($document->progress);
        $conceptors = Conceptor::get();
        return view('dokumen.dokumen2023.edit', compact('title', 'document', 'progress', 'conceptors'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('document2023.index')->with('success', 'Dokumen berhasil diedit');
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('document2023.index')->with('success', "Dokumen berhasil diimport");
    }
}
