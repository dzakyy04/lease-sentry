...
class Document2021Controller extends Controller
{
    public function index()
    {
        ...
        return view('dokumen.dokumen2021.index', compact('title', 'documents'));
    }
    ...
    public function create()
    {
        ...
        return view('dokumen.dokumen2021.create', compact('title', 'conceptors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('document2021.index')->with('success', 'Dokumen berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        $conceptors = Conceptor::get();
        return view('dokumen.dokumen2021.edit', compact('title', 'document', 'progress', 'conceptors'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('document2021.index')->with('success', 'Dokumen berhasil diedit');
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('document2021.index')->with('success', "Dokumen berhasil diimport");
    }
}
